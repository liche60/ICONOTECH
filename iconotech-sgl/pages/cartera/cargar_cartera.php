...
$url = "http://localhost:8080/iconotech-api/rest/cartera/procesos";
$json = \Httpful\Request::post($url)->body("01,01,1")->send();
...
jQuery(document).ready(function() {
  jQuery('#uploadForm').submit(function(e) {
    ...
    xhr.open("POST", 'http://localhost:8080/iconotech-api/rest/cartera/upload');
  ...
  //  xhr.open("post", oFormElement.action.replace(/(?:\?.*)?$/, sSearch.replace(/^&/, "?")), true);
    xhr.send(fd);
